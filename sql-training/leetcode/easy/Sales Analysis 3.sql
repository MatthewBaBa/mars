...
select distinct product_id, product_name from tmp
where product_id in (select product_id from tmp where sale_date BETWEEN  '2019-01-01' and '2019-03-31')
and product_id not in (select product_id from tmp where sale_date not between '2019-01-01' and  '2019-03-31')
;